...
export const LEVEL_CARDS = [
  {
    ...
    "chapterTitle": "序章：出门",
    "title": "镜子",
    "scene": "今天有一场重要见面。你站在镜子前，想起有人曾说你“不够认真”，也有人说你“太用力”。时间不多了，你需要决定以什么样子出门。",
    "choices": [
      {
        "id": "formal",
        "label": "更正式",
  ...
  },
  {
    ...
    "chapterTitle": "序章：出门",
    "title": "出门前",
    "scene": "手机电量只有37%。你想带充电宝和伞，但包会变重。天气预报说晚上可能下雨，而你还不知道自己几点能回来。",
    "choices": [
      {
        "id": "packed",
        "label": "带上所有东西",
  ...
  },
  {
    ...
    "chapterTitle": "序章：出门",
    "title": "电梯",
    "scene": "电梯门开了，里面已经有人。对方没有做什么，只是抬头看了你一眼。你赶时间，也还没有完全进入今天的状态。",
    "choices": [
      {
        "id": "enter",
        "label": "进去",
  ...
  },
  {
    ...
    "chapterTitle": "序章：出门",
    "title": "路口",
    "scene": "最近的路要穿过一段人少的地方。大路亮一些，但会多走十分钟。你已经不早了，手机导航把两条路都标得很平静。",
    "choices": [
      {
        "id": "shortcut",
        "label": "走近路",
  ...
  },
  {
    ...
    "chapterTitle": "第一章：筛选",
    "title": "照片",
    "scene": "申请表要求上传照片。你知道这不应该重要，但它在页面最上方。系统提示：资料越完整，处理越快。你停在上传按钮前，想了一会儿。",
    "choices": [
      {
        "id": "polished-photo",
        "label": "上传更精神的照片",
  ...
  },
  {
    ...
    "chapterTitle": "第一章：筛选",
    "title": "等待区",
    "scene": "等待区里有人聊天。他们提到“稳定”“抗压”“配合度”。轮到你之前还有三分钟。你可以接话，也可以把这几分钟留给自己。",
    "choices": [
      {
        "id": "join-chat",
        "label": "加入聊天",
  ...
  },
  {
    ...
    "chapterTitle": "第一章：筛选",
    "title": "职业规划",
    "scene": "面试官问：“你未来三到五年有什么计划？”这个问题听起来很标准。只是对方问完以后，没有立刻看简历，而是在等你的反应。",
    "choices": [
      {
        "id": "career",
        "label": "强调事业发展",
  ...
  },
  {
    ...
    "chapterTitle": "第一章：筛选",
    "title": "薪资",
    "scene": "对方给出的数字比招聘页低。解释是“试用期先这样，后面看表现”。你需要这份工作，也知道这个数字会跟着你进入下一个月。",
    "choices": [
      {
        "id": "accept",
        "label": "接受",
  ...
  },
  {
    ...
    "chapterTitle": "第一章：筛选",
    "title": "新人任务",
    "scene": "入职第一周，领导临时给你一个额外任务，说“这个你比较细心”。它不在职责里，但试用期还没过。你的原任务也还没有完成。",
    "choices": [
      {
        "id": "take-it",
        "label": "接下",
  ...
  },
  {
    ...
    "chapterTitle": "第一章：筛选",
    "title": "聚餐",
    "scene": "第一周结束，大家说要聚一下。你很累，但有人说：“新人还是来一下比较好。”消息停在群里，像一个不需要明说的提醒。",
    "choices": [
      {
        "id": "stay-full",
        "label": "参加到结束",
  ...
  },
  {
    ...
    "chapterTitle": "第一章：筛选",
    "title": "玩笑",
    "scene": "有人开了一个关于你的玩笑。它不算严重，甚至可以被解释成热络。你不舒服，但所有人都在等你怎么接。",
    "choices": [
      {
        "id": "laugh",
        "label": "笑一下",
  ...
  },
  {
    ...
    "chapterTitle": "第二章：房间",
    "title": "预算",
    "scene": "你打开租房软件。离公司近、门禁好、价格高；便宜的房子远一些，楼道灯坏了，评论也少。你第一次发现，住在哪里不是偏好，而是预算的形状。",
    "choices": [
      {
        "id": "near-expensive",
        "label": "近且贵",
  ...
  },
  {
    ...
    "chapterTitle": "第二章：房间",
    "title": "看房",
    "scene": "中介说房子很抢手，今天不定就没了。楼道灯确实有点暗，但房间里面还不错。门关上以后，外面的声音被隔得不太彻底。",
    "choices": [
      {
        "id": "book-now",
        "label": "当场定下",
  ...
  },
  {
    ...
    "chapterTitle": "第二章：房间",
    "title": "合同",
    "scene": "合同有几条你看不懂。中介说“都是模板，大家都这么签”。你已经跑了一下午，房源页面还不断弹出“已有多人咨询”。",
    "choices": [
      {
        "id": "sign",
        "label": "直接签",
  ...
  },
  {
    ...
    "chapterTitle": "第二章：房间",
    "title": "搬家加价",
    "scene": "搬家车到了楼下。师傅说楼梯费要另算，不然不上楼。你的东西已经在车上，旧房钥匙也快到交还时间。",
    "choices": [
      {
        "id": "pay",
        "label": "加钱",
  ...
  },
  {
    ...
    "chapterTitle": "第二章：房间",
    "title": "维修",
    "scene": "晚上十点半，维修的人终于到了。水管不能再拖，对方说“五分钟就好”。房间里还没收拾完，门口堆着刚搬来的纸箱。",
    "choices": [
      {
        "id": "let-in",
        "label": "让他进来",
  ...
  },
  {
    ...
    "chapterTitle": "第二章：房间",
    "title": "外卖",
    "scene": "骑手说已经到门口，问你能不能开门拿一下。他知道你的门牌号，你也确实饿了。猫眼外的走廊灯亮着，但不算很清楚。",
    "choices": [
      {
        "id": "open-door",
        "label": "立刻开门",
  ...
  },
  {
    ...
    "chapterTitle": "第二章：房间",
    "title": "邻居",
    "scene": "隔壁的人在门口和你搭话，问你是不是一个人住。语气很自然，像是随口一问。你手里还拿着钥匙，门半开着。",
    "choices": [
      {
        "id": "truth",
        "label": "如实回答",
  ...
  },
  {
    ...
    "chapterTitle": "第三章：路上",
    "title": "早高峰",
    "scene": "车厢很挤。你被推到门边。下一班要等六分钟，你今天不能再迟到了。你看见车门里还有一点空隙，也看见里面所有人都没有更多位置。",
    "choices": [
      {
        "id": "squeeze",
        "label": "挤进去",
  ...
  },
  {
    ...
    "chapterTitle": "第三章：路上",
    "title": "目光",
    "scene": "站台上有人一直看你。你换了位置，对方也慢慢挪近了一点。广播提示车快来了，人群开始往前移动。",
    "choices": [
      {
        "id": "look-back",
        "label": "看回去",
  ...
  },
  {
    ...
    "chapterTitle": "第三章：路上",
    "title": "低电量",
    "scene": "下班时手机只剩12%。今晚可能要晚回去。公司附近有便利店，但你已经很累，余额也不算宽。",
    "choices": [
      {
        "id": "buy-powerbank",
        "label": "买充电宝",
  ...
  },
  {
    ...
    "chapterTitle": "第三章：路上",
    "title": "加班后的路线",
    "scene": "晚上十点，地铁口到家有两条路。近路人少，大路绕远。打车价格翻倍。地图把它们标成三个普通选项。",
    "choices": [
      {
        "id": "shortcut",
        "label": "走近路",
  ...
  },
  {
    ...
    "chapterTitle": "第三章：路上",
    "title": "路线偏移",
    "scene": "司机说：“前面堵，我走另一边。”导航上的路线偏了一点。你不确定这是不是正常，也不想让车里的空气立刻变硬。",
    "choices": [
      {
        "id": "navigation",
        "label": "要求按导航走",
  ...
  },
  {
    ...
    "chapterTitle": "第三章：路上",
    "title": "楼道",
    "scene": "你到家楼下，后面有人也刷门禁进来。你不确定对方是不是住户。电梯门开了，里面的灯比大厅更白。",
    "choices": [
      {
        "id": "same-elevator",
        "label": "一起进电梯",
  ...
  },
  {
    ...
    "chapterTitle": "第四章：桌面",
    "title": "会议座位",
    "scene": "会议快开始了。主位旁边有空位，角落也有位置。你今天要汇报一部分内容。投影还没打开，大家已经开始随便坐下。",
    "choices": [
      {
        "id": "front",
        "label": "坐前面",
  ...
  },
  {
    ...
    "chapterTitle": "第四章：桌面",
    "title": "被打断",
    "scene": "你刚讲到关键部分，有人打断你，替你总结了一个并不准确的版本。大家已经开始点头，像是这个版本更容易被会议接收。",
    "choices": [
      {
        "id": "correct-now",
        "label": "立刻纠正",
  ...
  },
  {
    ...
    "chapterTitle": "第四章：桌面",
    "title": "功劳归属",
    "scene": "你的想法被另一个人重新包装后获得认可。领导说：“这个方向不错，你们继续跟。”你知道“你们”这个词可以很宽。",
    "choices": [
      {
        "id": "claim-source",
        "label": "当场说明来源",
  ...
  },
  {
    ...
    "chapterTitle": "第四章：桌面",
    "title": "别激动",
    "scene": "一个决定明显不公平。你提出异议后，对方说：“你先别激动，我们就事论事。”问题忽然从决定本身，滑向你的语气。",
    "choices": [
      {
        "id": "lower-voice",
        "label": "压低语气继续说",
  ...
  },
  {
    ...
    "chapterTitle": "第四章：桌面",
    "title": "绩效材料",
    "scene": "绩效面谈前，你要整理自己的贡献。很多事你做了，但没有留下明确记录。那些顺手接住的工作，很难变成表格里的成果。",
    "choices": [
      {
        "id": "rebuild-records",
        "label": "补材料",
  ...
  },
  {
    ...
    "chapterTitle": "第五章：靠近",
    "title": "朋友邀约",
    "scene": "朋友约你周末出来。你很久没见他们，但这一周已经很累。你知道关系也需要维护，不出现也会慢慢变成一种信息。",
    "choices": [
      {
        "id": "go",
        "label": "去",
  ...
  },
  {
    ...
    "chapterTitle": "第五章：靠近",
    "title": "第一次见面",
    "scene": "有人约你见面。对方提议去一个安静的地方，说那里人少、好聊天。你更想选人多的地方，但又不想显得太防备。",
    "choices": [
      {
        "id": "private-place",
        "label": "接受安静地点",
  ...
  },
  {
    ...
    "chapterTitle": "第五章：靠近",
    "title": "住址",
    "scene": "聊天很顺利。对方问：“你住哪边？我可以送你。”这听起来体贴，也可能让你暴露更多信息。你看了一眼时间。",
    "choices": [
      {
        "id": "name-compound",
        "label": "说小区名",
  ...
  },
  {
    ...
    "chapterTitle": "第五章：靠近",
    "title": "酒",
    "scene": "对方点了酒，说“少喝一点没事”。你不想扫兴，但你还要自己回家。杯子被推到你面前，像一个小小的气氛测试。",
    "choices": [
      {
        "id": "drink",
        "label": "喝一点",
  ...
  },
  {
    ...
    "chapterTitle": "第五章：靠近",
    "title": "靠近",
    "scene": "对方靠近了一点。你没有立刻后退。对方似乎把这理解成允许。灯光和音乐都很柔和，只有你的身体先紧了一下。",
    "choices": [
      {
        "id": "say-no",
        "label": "明确说“不”",
  ...
  },
  {
    ...
    "chapterTitle": "第五章：靠近",
    "title": "求证",
    "scene": "你把不舒服告诉朋友。朋友说：“他也没做什么吧？会不会是你想多了？”你本来只是想让事情清楚一点，现在却要先解释自己的感觉。",
    "choices": [
      {
        "id": "explain",
        "label": "继续解释",
  ...
  },
  {
    ...
    "chapterTitle": "第五章：靠近",
    "title": "退出",
    "scene": "你决定结束这段关系。对方发来很多消息，一会儿道歉，一会儿指责。你明天还要上班，手机却一直亮。",
    "choices": [
      {
        "id": "explain",
        "label": "解释清楚",
  ...
  },
  {
    ...
    "chapterTitle": "第六章：窗口",
    "title": "要不要处理",
    "scene": "事情已经过去几天。你可以当作没发生，也可以试着处理。你知道一旦开始，就要重新讲很多遍，把一段混乱的经历整理成别人能接收的格式。",
    "choices": [
      {
        "id": "formal",
        "label": "正式处理",
  ...
  },
  {
    ...
    "chapterTitle": "第六章：窗口",
    "title": "第一次陈述",
    "scene": "窗口后的人说：“你慢慢说，别激动。”你发现自己越想讲清楚，越像在辩解。屏幕上有一个空白记录框，等着你把事情放进去。",
    "choices": [
      {
        "id": "timeline",
        "label": "按时间线说",
  ...
  },
  {
    ...
    "chapterTitle": "第六章：窗口",
    "title": "有没有误会",
    "scene": "对方问：“会不会是误会？有没有可能对方不是这个意思？”你听过类似的话很多次。每一次都像是在把事情往更轻的地方推。",
    "choices": [
      {
        "id": "details",
        "label": "补充细节",
  ...
  },
  {
    ...
    "chapterTitle": "第六章：窗口",
    "title": "调解",
    "scene": "有人建议你们“沟通一下”。理由是事情不大，闹开了对谁都不好。你发现流程开始关心怎样恢复平静。",
    "choices": [
      {
        "id": "accept",
        "label": "接受调解",
  ...
  },
  {
    ...
    "chapterTitle": "第六章：窗口",
    "title": "公开",
    "scene": "你可以把经历发出去。你知道有人会支持你，也有人会审视你每一个细节。发送按钮就在下面，像一扇没有回头路的门。",
    "choices": [
      {
        "id": "public",
        "label": "公开发布",
  ...
  },
  {
    ...
    "chapterTitle": "第六章：窗口",
    "title": "反问",
    "scene": "问题一个接一个：“为什么不早点说？”“为什么没有证据？”“为什么当时不走？”你发现自己正在接受另一场审查。",
    "choices": [
      {
        "id": "answer-all",
        "label": "逐条回应",
  ...
  },
  {
    ...
    "chapterTitle": "第六章：窗口",
    "title": "处理结果",
    "scene": "系统给出结果：证据不足，但会提醒相关人员注意。你不能说它完全没用，也不能说它解决了什么。页面上显示“已处理”。",
    "choices": [
      {
        "id": "accept",
        "label": "接受结果",
